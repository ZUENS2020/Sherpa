...
4. 关键观测字段统一：`job_id`、`phase`、`error_code`。
...
3. K8s 部署说明：`/Users/zuens2020/Documents/Sherpa/docs/k8s/DEPLOY.md`
...
6. E2E 报告（zlib）：`/Users/zuens2020/Documents/Sherpa/docs/k8s/E2E_ZLIB_REPORT.md`
7. 映射说明：`/Users/zuens2020/Documents/Sherpa/docs/k8s/MAPPING.md`
