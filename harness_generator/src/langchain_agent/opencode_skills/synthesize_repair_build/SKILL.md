...
- If build diagnostics indicate missing system libraries (cmake/pkg-config errors), write canonical vcpkg port names to `fuzz/system_packages.txt` (one per line, lowercase).
